...
//                    }
                    ...
                    if (!instance.ConsigneeMobile.equals("null") && instance.ConsigneeMobile != null && !instance.ConsigneeMobile.equals("0")
                        ...
                        addMobileNumber(String.valueOf(i + 1) + " - " + instance.ItemNo, MNos, context);
            ...
            dbConnections.InsertComplaint(Complaint.length(), 0, GlobalVar.getDate(), context);
            dbConnections.close();
        } catch (JSONException e) {
            e.printStackTrace();
        }
    ...
    private void addMobileNumber(String ConsigneeName, ArrayList<String> ConsigneeMobile, Context context) {
...
//
            ...
            dbConnections.InsertMobileNumbers(ConsigneeName, mno, rawContactID, context);
            dbConnections.close();
