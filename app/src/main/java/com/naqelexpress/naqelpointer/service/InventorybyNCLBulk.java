...
public class InventorybyNCLBulk extends Service {
    ...
    private void startMyOwnForeground() {
        String NOTIFICATION_CHANNEL_ID = "com.naqelexpress.naqelpointer.service.InventorybyNCL";
    ...
    protected void updatefile() {
        ...
        try {
            ...
            Cursor result = db.Fill("select * from InventorybyNCL order by ID Limit 1 ", getApplicationContext());
    ...
    private class SaveAtTerminalHandling extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                URL url = new URL(GlobalVar.GV().NaqelPointerAPILink + "InsertTerminalHandlingByNCLBulk"); //LoadtoDestination
            ...
            try {
                ...
                if (finalJson != null) {
                    if (finalJson.contains("Created")) {
                        DBConnections db = new DBConnections(getApplicationContext(), null);
                        db.deleteInventoryByNCLID(id, getApplicationContext());
                        db.close();
