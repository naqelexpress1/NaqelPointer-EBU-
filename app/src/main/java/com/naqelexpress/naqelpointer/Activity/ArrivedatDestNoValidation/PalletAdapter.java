...
public class PalletAdapter
    ...
    public PalletAdapter(ArrayList<HashMap<String, String>> itemList, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = View.inflate(context, R.layout.waybilladapter_atdest, null);
        ...
        holder.piececount.setText(String.valueOf(item.get("PieceCount")));
