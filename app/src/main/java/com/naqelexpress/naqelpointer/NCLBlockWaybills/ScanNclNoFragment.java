...
public class ScanNclNoFragment extends Fragment {
    ...
    public int OriginID = 0, DestinationID = 0 ,  OriginFacilityID = 0 , DestinationFacilityID = 0;
        ...
        protected void onPostExecute(String finalJson) {
            ...
            if (finalJson != null) {
                ...
                try {
                    ...
                    fetchonhlodshipments(jsonObject.getJSONArray("HoldWaybills"));
    ...
    private void fetchonhlodshipments(JSONArray waybills) {
        ...
        for (int i = 0; i < waybills.length(); i++) {
            ...
            Log.d("test" , "Size : " + pieceDenied.get(i));
        }

        onholdshipments.setText(String.valueOf(waybills.length()) + " OnHold Shipments ");
