        ...
        extends RecyclerView.Adapter<DataAdapterForThird.ViewHolder>
{
    ...
    @Override
    public DataAdapterForThird.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i)
    {
    ...
    @Override
    public void onBindViewHolder(DataAdapterForThird.ViewHolder viewHolder, int i) {
