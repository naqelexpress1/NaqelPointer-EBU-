 ...
 */
public class TagsDemoActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    private static final LatLng Naqel = new LatLng(24.657774296291155, 46.78834106773139);
    private static final LatLng Ikea = new LatLng(24.661128435839704,46.78672101348639 );
...
//        MapFragment  mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.map);
    ...
    public void onMapReady(GoogleMap map) {
        ...
        map.setContentDescription("mohamed testing");
    ...
    private void addObjectsToMap() {
        ...
        mSydneyGroundOverlay = mMap.addGroundOverlay(new GroundOverlayOptions()
                .image(BitmapDescriptorFactory.fromResource(R.drawable.marker_60))
