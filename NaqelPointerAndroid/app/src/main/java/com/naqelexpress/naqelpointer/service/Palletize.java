...
public class Palletize extends Service {
    ...
    private void startMyOwnForeground() {
        String NOTIFICATION_CHANNEL_ID = "com.naqelexpress.naqelpointer.service.Palletize";
    ...
    protected void updatefile() {
        ...
        try {
            ...
            Cursor result = db.Fill("select * from Palletize Limit 1 ", getApplicationContext());
    ...
    public void SaveOnPalletize(final DBConnections db, final String input, final int id) {


        RequestQueue requestQueue = Volley.newRequestQueue(this);
        String URL = GlobalVar.GV().NaqelPointerAPILink + "SendPalletizeToServer";
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST,
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (IsSync && !HasError) {
                        db.deletePalletize(id, getApplicationContext());
