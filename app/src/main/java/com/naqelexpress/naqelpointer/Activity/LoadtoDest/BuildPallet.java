...
//                        palletNo.setText(barcode);
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putSerializable("waybilldetails", WayBillDetails.waybilldetails);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            WayBillDetails.waybilldetails = (ArrayList<HashMap<String, String>>) savedInstanceState.getSerializable("waybilldetails");
