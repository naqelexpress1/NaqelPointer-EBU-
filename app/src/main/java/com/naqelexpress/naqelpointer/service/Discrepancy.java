...
public class Discrepancy extends Service {
    ...
    private void startMyOwnForeground() {
        String NOTIFICATION_CHANNEL_ID = "com.naqelexpress.naqelpointer.service.Discrepancy";
    ...
    protected int count() {
        ...
        Cursor result = db.Fill("select * from Discrepancy Limit 1 ", getApplicationContext());
    ...
    public void SavetoDiscrepancy(final DBConnections db, final String input, final int id) {


        RequestQueue requestQueue = Volley.newRequestQueue(this);
        String URL = GlobalVar.GV().NaqelPointerAPILink + "SendDiscrepancyDS";
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST,
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (IsSync && !HasError) {
                        db.deleteDiscrepancy(id, getApplicationContext());
                        flag_thread = false;
