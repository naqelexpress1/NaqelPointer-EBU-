...
public class DeviceToken extends Service {
    ...
    private void startMyOwnForeground() {
        String NOTIFICATION_CHANNEL_ID = "com.naqelexpress.naqelpointer.service.DeviceToken";
    ...
    protected int count() {
        ...
        Cursor result = db.Fill("select * from DeviceToken Limit 1 ", getApplicationContext());
    ...
    public void SavetoDevicetoken(final DBConnections db, final String input, final int id) {


        RequestQueue requestQueue = Volley.newRequestQueue(this);
        String URL = GlobalVar.GV().NaqelPointerAPILink + "RegisterDeviceToken";
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST,
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (IsSync && !HasError) {
                        db.deleteDeviceToken(id, getApplicationContext());
                        flag_thread = false;
