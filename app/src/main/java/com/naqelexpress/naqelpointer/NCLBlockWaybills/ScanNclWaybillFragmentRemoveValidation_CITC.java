...
//        if (hvshipments != null)
//            if (hvshipments.contains(txtBarcode.getText().toString())) {
//                GlobalVar.ShowDialog(getActivity(), "Warning", "This Piece " + txtBarcode.getText().toString() + " is HV shipment ",
//                        true);
//                GlobalVar.GV().MakeSound(this.getContext(), R.raw.rto);
//            }
...
//                        lbTotal.setText(getString(R.string.lbCount) + String.valueOf(isduplicate.size()));
                    ...
                    builder.setTitle("Confirm Deleting")
                            ...
                            .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int which) {
                                    ...
                                    PiecesCount = PiecesCount - 1;
                                    //onLineValidationList.remove(getOnLineValidationPiece(PieceCodeList.get(position).Barcode));
                                }
                            })
    ...
    private boolean checkWaybillFlags(String barcode) {
        ...
        try {
            ...
            if (isDuplicate(getOnLineValidationPiece(barcode))) {
                onLineValidationList.remove(getOnLineValidationPiece(barcode));
            }
    ...
    private boolean isDuplicate(OnLineValidation onlineValidation) {

        if (onlineValidation == null) return false;

        for (OnLineValidation pieceDetail : onLineValidationList) {
            if (pieceDetail.getBarcode().equals(onlineValidation.getBarcode()))
                return true;
        }
        return false;
    }
    ...
    public void showFlagsPopup(final OnLineValidation onLineValidation) {
        try {
            ...
            if (onLineValidation != null) {
                ...
                if (!com.naqelexpress.naqelpointer.NCLBlockWaybills.ScanNclNoFragment.checkMix.isChecked())
                ...
                btnConfirm.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (alertDialog != null && alertDialog.isShowing()) {
                            ...
                            else if (onLineValidation.getIsDestNotBelongToNcl() == 1 && !isDestChanged && !com.naqelexpress.naqelpointer.NCLBlockWaybills.ScanNclNoFragment.checkMix.isChecked()) {
                                GlobalVar.GV().MakeSound(getContext(), R.raw.wrongbarcodescan);
