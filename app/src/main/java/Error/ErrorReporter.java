...
public class ErrorReporter implements Thread.UncaughtExceptionHandler {
    ...
    public String CreateInformationString() {
        ...
        String ReturnVal = "";
        ReturnVal += String.valueOf(GlobalVar.GV().EmployID);
    ...
    public void uncaughtException(Thread t, Throwable e) {
        ...
        Report += "Error Report collected on : " + DateTime.now().toString();
        Report += "\n";
        Report += "\n";
        Report += "Informations :";
        Report += "\n";
...
//    }
    ...
    public static void WriteBatteryState(String batterystate) {
        try {
            new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/TerminalHandling/ErrorState/").mkdirs();
            File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/TerminalHandling/ErrorState/ErrorReport.txt");
            if (!file.exists()) {
                file.createNewFile();
            }

            FileOutputStream fileOutputStream = new FileOutputStream(file, true);
            fileOutputStream.write((batterystate + System.getProperty("line.separator")).getBytes());
