...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        destinationEditText.setText("Ministry of the National Guard Makkah Al Mukarramah Branch Road, Ar Rabwah Riyadh 12822 Saudi-Arabia");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        sydney = new LatLng(24.657542878415438, 46.78949257583818);
