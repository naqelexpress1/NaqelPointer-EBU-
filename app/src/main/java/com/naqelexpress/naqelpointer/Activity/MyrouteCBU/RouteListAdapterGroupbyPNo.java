...
public class RouteListAdapterGroupbyPNo
        extends RecyclerView.Adapter<RouteListAdapterGroupbyPNo.MyViewHolder> implements Filterable {
    private Context context;
    private List<MyRouteShipments> itemList;
    private String class_;
    private List<MyRouteShipments> itemListFiltered;
    private MyRouteActivity_Complaince_GroupbyPhn listener;

    public RouteListAdapterGroupbyPNo(Context context, List<MyRouteShipments> itemList, String calss_,
                                      MyRouteActivity_Complaince_GroupbyPhn listener) {
