...
//    public void setCallback(ResultInterface myinterface) {
//        this.myinterface = myinterface;
//    }

//    public void updateData(ArrayList<HashMap<String, String>> waybillsdata) {
//        this.waybills.addAll(waybillsdata);
