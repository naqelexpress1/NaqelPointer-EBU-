...
public class CustomerRating extends Service {
    ...
    private void startMyOwnForeground() {
        String NOTIFICATION_CHANNEL_ID = "com.naqelexpress.naqelpointer.service.CustomerRating";
    ...
    protected void updatefile() {
        ...
        try {
            ...
            Cursor result = db.Fill("select * from CustomerRating Limit 1 ", getApplicationContext());
    ...
    private class SaveAtOrigin extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                URL url = new URL(GlobalVar.GV().NaqelPointerAPILink + "SaveCustomerRatings"); //LoadtoDestination
        ...
        protected void onPostExecute(String finalJson) {
            if (finalJson != null) {
                if (finalJson.contains("201 - Created Successfully")) {
                    DBConnections db = new DBConnections(getApplicationContext(), null);
                    db.deleteAtCustomerRating(id, getApplicationContext());
                    flag_thread = false;
                    db.close();
                }
