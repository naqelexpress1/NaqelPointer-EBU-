...
public class VehicleManifest extends Service {
    ...
    private void startMyOwnForeground() {
        String NOTIFICATION_CHANNEL_ID = "com.naqelexpress.naqelpointer.service.VehicleManifest";
    ...
    protected void updatefile() {
        ...
        try {
            ...
            Cursor result = db.Fill("select * from TripPlanDDetails where IsSync = 1 Limit 1 ", getApplicationContext());
