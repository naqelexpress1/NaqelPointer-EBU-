 ...
 */
public class CallRecord extends JobService {
    ...
    static {
        JobInfo.Builder builder = new JobInfo.Builder(4001,
                new ComponentName("com.naqelexpress.naqelpointer", CallRecord.class.getName()));
