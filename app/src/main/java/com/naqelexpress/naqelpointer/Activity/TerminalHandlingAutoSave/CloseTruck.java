...
public class CloseTruck extends AppCompatActivity implements View.OnClickListener {
        ...
        builder.setTitle("Exit")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int which) {
                        com.naqelexpress.naqelpointer.Activity.TerminalHandlingAutoSave.CloseTruck.super.onBackPressed();
                    }
    ...
    private void ShowAlertMessage(String message, final int finish) {
        AlertDialog alertDialog = new AlertDialog.Builder(com.naqelexpress.naqelpointer.Activity.TerminalHandlingAutoSave.CloseTruck.this).create();
    ...
    private class truckclose extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            ...
            if (progressDialog == null)
                progressDialog = ProgressDialog.show(com.naqelexpress.naqelpointer.Activity.TerminalHandlingAutoSave.CloseTruck.this,
