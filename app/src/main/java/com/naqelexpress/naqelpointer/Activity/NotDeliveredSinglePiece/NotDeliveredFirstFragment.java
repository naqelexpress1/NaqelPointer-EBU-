...
public class NotDeliveredFirstFragment extends Fragment implements DatePickerDialog.OnDateSetListener {
    ...
    EditText txtWaybillNo, txtReason, txtNotes, txtsubReason;
...
//            Button save = (Button) rootView.findViewById(R.id.btnOpenCamera);
//            save.setOnClickListener(new View.OnClickListener() {
//                @Override
//                public void onClick(View v) {
//                    if (GlobalVar.ValidateAutomacticDate(getContext())) {
//                        if (txtWaybillNo.getText().toString().length() == 0) {
//                            GlobalVar.ShowDialog(getActivity(), "Info", "Please Enter Waybill Correctly", true);
//                            return;
//                        }
...
//        DBConnections dbConnections = new DBConnections(getContext(), null);
//        if (IsValid()) {
//            dbConnections.UpdateProductivity_Exceptions(GlobalVar.getDate(), getContext());
//
//
//            boolean IsSaved = true;
//            NotDelivered notDelivered = new NotDelivered(txtWaybillNo.getText().toString(), 0,
//                    TimeIn, DateTime.now(), String.valueOf(Latitude), String.valueOf(Longitude), firstFragment.ReasonID,
//                    txtNotes.getText().toString(), subReasonId);
//
