...
import android.support.v7.widget.AppCompatImageButton;import androidx.recyclerview.widget.LinearLayoutManager;
...
//                                    , getActivity().getApplicationContext());
            ...
            GlobalVar.GV().hideKeyboardFrom(getContext(), rootView);
    ...
    private void ReadFromLocal(Cursor result, DBConnections dbConnections) {
        ...
        if (!isdelivered) {
            ...
            try {
                ...
                PieceCount = waybillDetailsResult.PiecesCount;
