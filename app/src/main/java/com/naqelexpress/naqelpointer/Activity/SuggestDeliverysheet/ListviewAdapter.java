...
public class ListviewAdapter
    ...
    public ListviewAdapter(ArrayList<HashMap<String, String>> itemList, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = View.inflate(context, R.layout.ebulistview, null);
        ...
        holder.mobileno.setText(String.valueOf(item.get("PhoneNumber")));
        holder.duration.setText("Duration :" + String.valueOf(item.get("Duration")));
...
//            convertView.setBackgroundColor(Color.parseColor("#00b339"));
    ...
    class ViewHolder {
        TextView waybillno, mobileno,duration;
