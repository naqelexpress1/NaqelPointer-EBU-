...
public class NewBarCodeScannerForVS_Old extends AppCompatActivity
...
//
    ...
    public void conflict(String Barcode) {
        AlertDialog.Builder builder = new AlertDialog.Builder(NewBarCodeScannerForVS_Old.this);
        builder.setTitle("Warning " + Barcode)
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int which) {
                        ...
                        mScannerView.resumeCameraPreview(NewBarCodeScannerForVS_Old.this);
                    }
                });
    ...
    public void showDialog(OnLineValidation pieceDetails) {
        try {
            if (pieceDetails != null) {
                final android.app.AlertDialog.Builder dialogBuilder = new android.app.AlertDialog.Builder(NewBarCodeScannerForVS_Old.this);
