...
public class DataAdapterForThird
    ...
    public DataAdapterForThird(ArrayList<String> itemList, Context context, Activity activity) {
            ...
            alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "Yes",
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            dbConnections.deleteLoadtoDestPiece(message, context);
                            dbConnections.close();
                            itemList.remove(message);
                            notifyDataSetChanged();
                            dialog.dismiss();
                            SingleLoad.lbTotal.setText("Count : " + String.valueOf(itemList.size()));
                        }
                    });
